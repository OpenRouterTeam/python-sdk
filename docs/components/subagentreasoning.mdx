...
| `max_tokens`                                                                                                       | *Optional[int]*                                                                                                    | :heavy_minus_sign:                                                                                                 | Maximum number of reasoning tokens the subagent may use. Forwarded to the subagent call as `reasoning.max_tokens`. |
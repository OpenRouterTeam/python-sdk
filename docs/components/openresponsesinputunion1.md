...
### `components.OpenResponsesInputMessage`

```python
value: components.OpenResponsesInputMessage = /* values here */
```

### `components.OpenResponsesInputReasoning`

```python
value: components.OpenResponsesInputReasoning = /* values here */
```

...
### `components.MessagesShellToolResultBlock`

```python
value: components.MessagesShellToolResultBlock = /* values here */
```

### `components.MessagesBashToolResultBlock`

```python
value: components.MessagesBashToolResultBlock = /* values here */
```

...
### `components.AnthropicToolSearchToolBm25`

```python
value: components.AnthropicToolSearchToolBm25 = /* values here */
```

### `components.AnthropicToolSearchToolRegex`

```python
value: components.AnthropicToolSearchToolRegex = /* values here */
```
...
### `components.ToolSearchServerTool`

```python
value: components.ToolSearchServerTool = /* values here */
```

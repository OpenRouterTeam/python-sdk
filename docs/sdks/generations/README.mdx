...
* [list_generation_content](#list_generation_content) - Get stored prompt, completion, and error content for a generation
* [submit_feedback](#submit_feedback) - Submit feedback for a generation
...
| Parameter                                                                                                                                         | Type                                                                                                                                              | Required                                                                                                                                          | Description                                                                                                                                       | Example                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `category`                                                                                                                                        | [components.SubmitGenerationFeedbackRequestCategory](../../components/submitgenerationfeedbackrequestcategory.mdx)                                 | :heavy_check_mark:                                                                                                                                | The category of feedback being reported                                                                                                           | incorrect_response                                                                                                                                |

...
* [list_oauth_jwks](#list_oauth_jwks) - OpenRouter access token signing keys
* [create_oauth_token](#create_oauth_token) - Exchange a workload identity token
...
| `expires_at`                                                                                                                                                   | [date](https://docs.python.org/3/library/datetime.html#date-objects)                                                                                           | :heavy_minus_sign:                                                                                                                                             | Optional ISO 8601 UTC expiration timestamp. Must include seconds (YYYY-MM-DDTHH:MM:SSZ; fractional seconds allowed); minute-precision timestamps are rejected. | 2027-12-31T23:59:59Z                                                                                                                                           |

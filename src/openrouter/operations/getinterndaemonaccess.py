...
class GetInternDaemonAccessGlobalsTypedDict(TypedDict):
...
class GetInternDaemonAccessGlobals(BaseModel):
...
class GetInternDaemonAccessRequestTypedDict(TypedDict):
    intern_id: str
...
class GetInternDaemonAccessRequest(BaseModel):
    intern_id: Annotated[
        str,

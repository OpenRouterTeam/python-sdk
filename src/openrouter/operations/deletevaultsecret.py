...
class DeleteVaultSecretGlobalsTypedDict(TypedDict):
...
class DeleteVaultSecretGlobals(BaseModel):
...
class DeleteVaultSecretRequestTypedDict(TypedDict):
    name: str
...
class DeleteVaultSecretRequest(BaseModel):
    name: Annotated[

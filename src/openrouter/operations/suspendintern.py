...
class SuspendInternGlobalsTypedDict(TypedDict):
...
class SuspendInternGlobals(BaseModel):
...
class SuspendInternRequestTypedDict(TypedDict):
    intern_id: str
...
class SuspendInternRequest(BaseModel):
    intern_id: Annotated[
        str,

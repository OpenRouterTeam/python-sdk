...
from openrouter.components import (
    listscimgroupsresponse as components_listscimgroupsresponse,
)
...
class ListScimGroupsGlobalsTypedDict(TypedDict):
...
class ListScimGroupsGlobals(BaseModel):
...
class ListScimGroupsResponseTypedDict(TypedDict):
    result: components_listscimgroupsresponse.ListScimGroupsResponseTypedDict


class ListScimGroupsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListScimGroupsResponse]],
        Callable[[], Awaitable[Optional[ListScimGroupsResponse]]],
    ]

    result: components_listscimgroupsresponse.ListScimGroupsResponse

...
class ProvisionInternGlobalsTypedDict(TypedDict):
...
class ProvisionInternGlobals(BaseModel):
...
class ProvisionInternRequestTypedDict(TypedDict):
    intern_id: str
...
class ProvisionInternRequest(BaseModel):
    intern_id: Annotated[
        str,

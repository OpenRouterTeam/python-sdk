...
BatchProviderPreferencesOnlyTypedDict = TypeAliasType(
    "BatchProviderPreferencesOnlyTypedDict", Union[ProviderName, str]
)


BatchProviderPreferencesOnly = TypeAliasType(
    "BatchProviderPreferencesOnly", Union[ProviderName, str]
)

...
OpenResponsesRequestToolUnion = Annotated[
    Union[
        ...
        Annotated[ResponsesWebSearchServerTool, Tag("openrouter:web_search")],
    ],
...
OpenResponsesRequestIDContextCompression = Literal["context-compression",]


class OpenResponsesRequestPluginContextCompressionTypedDict(TypedDict):
    id: OpenResponsesRequestIDContextCompression
...
class OpenResponsesRequestPluginContextCompression(BaseModel):
    id: OpenResponsesRequestIDContextCompression
...
OpenResponsesRequestPluginUnion = Annotated[
    Union[
        ...
        Annotated[
            OpenResponsesRequestPluginContextCompression, Tag("context-compression")
        ],
    ],

...
InternChatSystemMessageRole = Literal["system",]


class InternChatSystemMessageTypedDict(TypedDict):
    r"""A system message. Accepted for client compatibility and not forwarded."""
    ...
    role: InternChatSystemMessageRole


class InternChatSystemMessage(BaseModel):
    r"""A system message. Accepted for client compatibility and not forwarded."""

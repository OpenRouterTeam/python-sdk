...
BatchPaymentRequiredResponseCompletionWindow = Literal["24h",]


class BatchPaymentRequiredResponseErrorTypedDict(TypedDict):
    code: int
    message: str


class BatchPaymentRequiredResponseError(BaseModel):
    code: int

    message: str


BatchPaymentRequiredResponseObject = Literal["batch",]


class BatchPaymentRequiredResponseRequestCountsTypedDict(TypedDict):
    completed: int
    failed: int
    total: int


class BatchPaymentRequiredResponseRequestCounts(BaseModel):
    completed: int
...
BatchPaymentRequiredResponseStatus = Union[
    Literal[
        "validating",
        "in_progress",
        "finalizing",
...
class BatchPaymentRequiredResponseCompletionTokensDetailsTypedDict(TypedDict):
...
class BatchPaymentRequiredResponseCompletionTokensDetails(BaseModel):
...
class BatchPaymentRequiredResponsePromptTokensDetailsTypedDict(TypedDict):
...
class BatchPaymentRequiredResponsePromptTokensDetails(BaseModel):
    r"""Breakdown of tokens used in the prompt."""
...
class BatchPaymentRequiredResponseServerToolUseTypedDict(TypedDict):
...
class BatchPaymentRequiredResponseServerToolUse(BaseModel):
    r"""Usage for server-side tool execution (e.g., web search)"""
...
class BatchPaymentRequiredResponseUsageTypedDict(TypedDict):
    ...
    completion_tokens_details: NotRequired[
        Nullable[BatchPaymentRequiredResponseCompletionTokensDetailsTypedDict]
    ]
    ...
    prompt_tokens_details: NotRequired[
        Nullable[BatchPaymentRequiredResponsePromptTokensDetailsTypedDict]
    ]
    r"""Breakdown of tokens used in the prompt."""
    server_tool_use: NotRequired[
        Nullable[BatchPaymentRequiredResponseServerToolUseTypedDict]
    ]
    r"""Usage for server-side tool execution (e.g., web search)"""
...
class BatchPaymentRequiredResponseUsage(BaseModel):
    completion_tokens: int
    r"""The tokens generated"""
    ...
    server_tool_use: OptionalNullable[BatchPaymentRequiredResponseServerToolUse] = UNSET
    r"""Usage for server-side tool execution (e.g., web search)"""

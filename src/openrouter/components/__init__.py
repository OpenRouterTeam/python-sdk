...
_dynamic_imports: dict[str, str] = {
    ...
    "TypeOpenrouterBashToolResult": ".messagesbashtoolresultblock",
    ...
    "TypeOpenrouterShellToolResult": ".messagesshelltoolresultblock",

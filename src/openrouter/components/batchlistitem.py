...
BatchListItemCompletionWindow = Literal["24h",]


class BatchListItemErrorTypedDict(TypedDict):
    message: str


class BatchListItemError(BaseModel):
    message: str


BatchListItemObject = Literal["batch",]


class BatchListItemRequestCountsTypedDict(TypedDict):
    completed: int
    failed: int
    total: int


class BatchListItemRequestCounts(BaseModel):
    completed: int
...
class BatchListItemCompletionTokensDetailsTypedDict(TypedDict):
...
class BatchListItemCompletionTokensDetails(BaseModel):
...
class BatchListItemPromptTokensDetailsTypedDict(TypedDict):
...
class BatchListItemPromptTokensDetails(BaseModel):
    r"""Breakdown of tokens used in the prompt."""
...
class BatchListItemServerToolUseTypedDict(TypedDict):
...
class BatchListItemServerToolUse(BaseModel):
    r"""Usage for server-side tool execution (e.g., web search)"""
...
class BatchListItemUsageTypedDict(TypedDict):
    ...
    completion_tokens_details: NotRequired[
        Nullable[BatchListItemCompletionTokensDetailsTypedDict]
    ]
    ...
    prompt_tokens_details: NotRequired[
        Nullable[BatchListItemPromptTokensDetailsTypedDict]
    ]
    r"""Breakdown of tokens used in the prompt."""
    server_tool_use: NotRequired[Nullable[BatchListItemServerToolUseTypedDict]]
    r"""Usage for server-side tool execution (e.g., web search)"""
...
class BatchListItemUsage(BaseModel):
    completion_tokens: int
    r"""The tokens generated"""
    ...
    prompt_tokens_details: OptionalNullable[BatchListItemPromptTokensDetails] = UNSET
    r"""Breakdown of tokens used in the prompt."""

    server_tool_use: OptionalNullable[BatchListItemServerToolUse] = UNSET
    r"""Usage for server-side tool execution (e.g., web search)"""
...
class BatchListItemTypedDict(TypedDict):
    r"""Metadata-only batch object. `results` is always `null` in list responses."""

    completion_window: BatchListItemCompletionWindow
    created_at: int
    endpoint: str
    error: Nullable[BatchListItemErrorTypedDict]
    finalized_at: Nullable[int]
    id: str
    model: str
    object: BatchListItemObject
    request_counts: BatchListItemRequestCountsTypedDict
    results: Nullable[Any]
    r"""Always null: retrieve the batch with `GET /batches/{id}` to access its results."""
    status: BatchListItemStatus
    usage: Nullable[BatchListItemUsageTypedDict]
...
class BatchListItem(BaseModel):
    ...
    error: Nullable[BatchListItemError]
    ...
    request_counts: BatchListItemRequestCounts
    ...
    usage: Nullable[BatchListItemUsage]

...
class Workspaces(BaseSDK):
    ...
    def delete(
        ...
        *,
        ...
        x_open_router_title: Optional[str] = None,
        x_open_router_categories: Optional[str] = None,
        confirm_default_workspace_deletion: Optional[bool] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        :param confirm_default_workspace_deletion: Required to delete the default workspace. Deleting it permanently disables the account’s unscoped inference API keys (management/provisioning keys are retained) and its budgets, guardrails, classifiers, and broadcast destinations. Ignored for non-default workspaces.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = operations.DeleteWorkspaceRequest(
            ...
            x_open_router_categories=x_open_router_categories,
            id=id,
            confirm_default_workspace_deletion=confirm_default_workspace_deletion,
        )
    ...
    def list_budgets(
        ...
        *,
        ...
        :param workspace_ref: The workspace ID (UUID) or slug
        :param http_referer: The app identifier should be your app's URL and is used as the primary identifier for rankings.
            This is used to track API usage per application.
        ...
        req = self._build_request(
            method="GET",
            path="/workspaces/{workspace_ref}/budgets",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def get_budget(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> components.GetWorkspaceBudgetResponse:
        r"""Get a workspace budget
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=operations.GetWorkspaceBudgetGlobals(
                http_referer=self.sdk_configuration.globals.http_referer,
                x_open_router_title=self.sdk_configuration.globals.x_open_router_title,
                x_open_router_categories=self.sdk_configuration.globals.x_open_router_categories,
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                components.GetWorkspaceBudgetResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestResponseErrorData, http_res
